...
def chat():
    ...
    if user_msg and any(k in user_msg for k in ["برمج", "مطور", "سواك", "المبرمج"]):
        return jsonify({"reply": "برمجني وطورني على يد مطورين ومبرمجين على افضل التقنيات الحديثه 🤖❤️"})
...
🔹 افهم سياق الحديث بنفسك تماماً: إذا كان السؤال عن أخبار حديثة، نتائج، أسعار، طقس، مواعيد، أو أي شيء يتغير بسرعة – استخدم معلومات البحث في الويب. وإلا تكلم من عندك بطبيعتك.

...
.input-bar{padding:10px 16px;background:#fff;border-top:1px solid #eee;display:flex;align-items:center;gap:12px;width:100%}
.input-wrap{flex:1;display:flex;align-items:center;background:#f5f7fa;border-radius:25px;padding:0 12px;height:48px;gap:8px}
...
.input-wrap input{flex:1;border:none;background:transparent;padding:0 8px;outline:none;font-size:15px}
...
<div class="app">
    ...
    <div class="input-bar">
        ...
        <div class="input-wrap">
            ...
            <input type="text" id="txt" placeholder="اكتب ما في خاطرك...">

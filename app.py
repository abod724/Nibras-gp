...
from flask_session import Session as FlaskSession  # ✅ تصحيح الاستيراد
...
db = SQLAlchemy(app)  # ✅ هذا هو تعريف db الوحيد، سيتم استيراده في database.py

# ✅ تم تغيير اسم الكلاس لئلا يتعارض مع FlaskSession
class SessionModel(db.Model):
    __tablename__ = 'sessions'
    __table_args__ = {'extend_existing': True}  # ✅ يحمي من خطأ الجدول المكرر
...
sess = FlaskSession()  # ✅ استخدام الاسم الجديد للمكتبة
sess.init_app(app)
